...
<h2 style="font-size: 40px; color:black; margin-left: 55px; margin-top: 80px;">Eliminar Grado Policial</h2>
 <section class="content bgcolor-1" style="margin-left: 80px;">
				<span class="input input--nao">
					<input class="input__field input__field--nao" type="text" id="input-1" name="Nombre" value="<?php echo "$ID"; ?>" />
				...
				<span class="input input--nao">
					<input class="input__field input__field--nao" type="text" id="input-2" name="Motivo" />
