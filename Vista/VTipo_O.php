...
$sx=$md->Cargar_Tipo_O();
 ...
 <h1 style="margin-top: -60px;">TIPO DE OFICIAL</h1>
<div class="row" style="margin-top: -90px;">
          <table class="table table-striped table-bordered">
            ...
            <tbody>
                  ...
                  <?php echo '<tr>';?>
                        <?php echo '<td style="text-align:center;">'. $row['ID_Tipo_O'] . '</td>';?>
                        ...
                        <?php echo '<a class="btn btn-success" href="../Vista/VMTipo_O.php?ID='.$row['ID_Tipo_O'].'"">Modificar</a> ';?>
                        <?php echo '<a class="btn btn-danger" href="../Vista/VETipo_O.php?ID='.$row['ID_Tipo_O'].'">Eliminar</a>';?>
                        <?php echo '</td>';?>
                <?php }?>
            </tbody>
          </table>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
          <div class="modal-header" style="background: black; color: white;">
            ...
            <h4 class="modal-title">Registro Tipo de Oficial</h4>
          </div>
        <div class="modal-body">
                <div class="span10 offset1">
                <form method="POST" action="../Controlador/CTipo_O.php">
